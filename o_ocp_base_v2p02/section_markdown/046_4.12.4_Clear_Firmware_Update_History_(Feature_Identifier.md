...
| CFUH-13 | 11 | Clear Firmware Update History Log | 31 | Set to 1b to clear the Firmware Activation History (Log Identifier C2h). The NVMe CLI plugin in command “clear-fw-activate-history” can also perform this operation. |
