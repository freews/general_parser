...
| SMART-22 | 151:144 | Security Version Number | 8 | This is the Security Version Number of the currently running firmware image. The supplier includes a fix for a security issue or critical firmware fix that customer agrees rollback prevention is required. |
| SMART-23 | 159:152 | Total NUSE | 8 | Total Namespace Utilization. For a device with a single Namespace, this shall be a copy of the Identify Namespace Data Structure bytes 23:16. For a device with multiple namespaces, this shall reflect the total utilization based on all the Namespaces. |
...
| SMART-28 | 511:496 | Log Page GUID | 16 | Shall be set to AFD514C97C6F49FCA4F2BEA2810AFC5h. |
