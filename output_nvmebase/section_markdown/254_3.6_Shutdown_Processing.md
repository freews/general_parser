...
#### Table 1: Table_3_6_Shutdown_Processing
![Table_3_6_Shutdown_Processing](../section_images/Table_3_6_Shutdown_Processing.png)
...
| Notes: | | | | | |
| 1. | | | | | |
| In some cases (e.g., following initial application of power, or following a Controller Level Reset that occurred while shutdown processing was reported as complete), the controller is permitted to initialize the media and cease being ready to be powered off as a consequence | | | | | |
