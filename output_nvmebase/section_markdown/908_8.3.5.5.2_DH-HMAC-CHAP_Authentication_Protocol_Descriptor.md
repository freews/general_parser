...
#### Table 1: Table_8_3_5_5_2_DH_HMAC_CHAP_Authentication_Protocol_Descriptor
![Table_8_3_5_5_2_DH_HMAC_CHAP_Authentication_Protocol_Descriptor](../section_images/Table_8_3_5_5_2_DH_HMAC_CHAP_Authentication_Protocol_Descriptor.png)
...
| 3 | DHgIDList Length (DHLLEN): Number of Diffie-Hellman group identifiers (1 to 30) |
...
| 33+DHLLEN:34 | Diffie-Hellman Group Identifier List (DHgIDList): Array of Diffie-Hellman group identifiers (one byte per identifier) |
| 63:34+DHLLEN | Pad1 (PAD1): Padding bytes cleared to 0h, if present |
| | |
...
| | | | | |
| Identifier | DH group size | Generator (g) | Modulus (p) | Reference |
| 00h | NULL | n/a | n/a | |
