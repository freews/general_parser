...
#### Figure 1: Figure 626: RPMB Boot Partition Write Protection State Machine Model
![Figure 626: RPMB Boot Partition Write Protection State Machine Model](../section_images/Figure_8_1_3_3_2_RPMB_Boot_Partition_Write_Protection_1.png)


#### Figure 2: Figure 628 defines the write protection states per Boot Partition if RPMB Boot Partition Write Protection is
supported.
![Figure 628 defines the write protection states per Boot Partition if RPMB Boot Partition Write Protection is
supported.](../section_images/Figure_8_1_3_3_2_RPMB_Boot_Partition_Write_Protection_2.png)
