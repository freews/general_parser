...
#### Table 1: Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_1
![Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_1](../section_images/Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_1.png)
...
#### Table 2: Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_2
![Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_2](../section_images/Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_2.png)

Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_2
...
#### Table 3: Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_3
![Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_3](../section_images/Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_3.png)
...
#### Table 4: Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_4
![Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_4](../section_images/Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_4.png)
...
| Authentication Permitted | NEWTLSPSK or REPLACETLSPSK | Disconnect from the host |
| | NOSC | Participate in the authentication transaction |
| Authentication Required | NEWTLSPSK or REPLACETLSPSK | Disconnect from the host |
| | NOSC | Participate in the authentication transaction |


#### Table 5: Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_5
![Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_5](../section_images/Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_5.png)

| Configuration | Description |
| :--- | :--- |
| Authentication Disabled | TLS Disabled <br> Authentication and set up of a secure channel with a remote entity not allowed |
| Authentication Permitted | TLS Disabled <br> Authentication of a remote entity allowed, set up of a secure channel not allowed |
| | TLS Permitted <br> Authentication and set up of a secure channel with a remote entity allowed |
| Configuration | Description |
| Authentication Required | TLS Disabled <br> Authentication of a remote entity required, set up of a secure channel not allowed |
| | TLS Permitted <br> Authentication of a remote entity required, set up of a secure channel allowed |
| | TLS Required <br> Authentication and set up of a secure channel with a remote entity required |


#### Table 6: Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_6
![Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_6](../section_images/Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_6.png)

| Configuration | ASCR | ATR |
| :--- | :--- | :--- |
| Authentication Disabled | TLS Disabled | 0 |
| | TLS Disabled | 0 |
| Authentication Permitted | TLS Permitted | 0 |
| | TLS Disabled | 0 |
| Authentication Required | TLS Disabled | 0 |
| | TLS Permitted | 1 |
| | TLS Required | 0 |


#### Table 7: Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_7
![Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_7](../section_images/Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_7.png)

| Host Configuration | ASCR | ATR | Action |
| :--- | :--- | :--- | :--- |
| Authentication Disabled | TLS Disabled | 0 | 0 | Do not begin an authentication transaction |
| | | 0 | 1 | Disconnect from the NVM subsystem |
| | | 1 | any | If the TASC field in the Discovery Log Page Entry for the remote entity is set to 01b or set to 10b, then begin an authentication transaction with the SC_C field set to NOSC. |
| Authentication Permitted | TLS Disabled | 0 | 0 | If the TASC field in the Discovery Log Page Entry for the remote entity is cleared to 00b or set to 11b or if no Discovery Log Page Entry for the remote entity has been retrieved, then do not begin an authentication transaction. |
| | | 0 | 1 | Begin an authentication transaction with the SC_C field set to NOSC |
| | | 1 | any | Disconnect from the NVM subsystem |
...
#### Table 8: Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_8
![Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_8](../section_images/Table_8_3_5_5_11_DH_HMAC_CHAP_Configuration_8.png)
