...
#### Table 1: Table_8_3_5_5_3_DH_HMAC_CHAP_Challenge_Message
![Table_8_3_5_5_3_DH_HMAC_CHAP_Challenge_Message](../section_images/Table_8_3_5_5_3_DH_HMAC_CHAP_Challenge_Message.png)
...
| 15:12 | Sequence Number (SEQNUN): Sequence number S₁ |
| 15+HL:16 | Challenge Value (CVAL): Challenge C₁ |
| 15+HL+DHVLEN:16+HL | DH Value (DHV): DH exponential gⁱ mod p. This field is not present (i.e., the CVAL field is the last field in the message) if DHVLEN field is cleared to 0h |
