...
| | | **Bits** | **Description** |
| 00 | 7 | Reserved |
| | 6:4 | **Next Active Firmware Slot (NAFS):** This field indicates the firmware slot that is going to be activated at the next Controller Level Reset. If this field is cleared to 0h, then the controller does not indicate the firmware slot that is going to be activated at the next Controller Reset. |
| | 3 | Reserved |
