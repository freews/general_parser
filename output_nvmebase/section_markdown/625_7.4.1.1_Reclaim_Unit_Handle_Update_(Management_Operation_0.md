...
| ... | |
| (NPID*2)+1: | **Placement Identifier NPID:** This field specifies the last Placement Identifier that indicates a Placement Handle and a Reclaim Group Identifier, if any. Refer to Figure 289 and Figure 290. |
