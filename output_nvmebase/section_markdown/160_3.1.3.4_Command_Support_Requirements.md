...
| Command | Combined Opcode Value | Controller Support Requirements¹ | | | | Reference |
| | | I/O | Administrative | Discovery | | |
| Fabric Zoning Receive | 22h | O | P | M⁷ | | 5.4.6 |
...
| 7. Mandatory if CDCs and optional for Discovery controllers that are not a CDC. | | | | | | |
...
| 3. Mandatory for controllers that support the Flexible Data Placement capability (refer to section 8.1.11). Refer to the FDP bit in Figure 328. | | | | | | |
