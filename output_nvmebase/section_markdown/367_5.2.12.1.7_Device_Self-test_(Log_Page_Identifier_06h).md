...
| Bytes | Description |
| :--- | :--- |
| | **Power On Hours (POH):** This field indicates the number of power-on hours at the time the device self-test operation was completed or aborted. This does not include time that the controller was powered and in a low power state condition. |
| 11:04 | |
| | **Namespace Identifier (NSID):** This field indicates the namespace that the Failing LBA occurred. The contents of this field are valid only when the NSID Valid bit is set to '1'. |
| 15:12 | |
...
| | **Status Code Type (SCTC):** This field may contain additional information related to errors or conditions. |
| | | **Bits** | **Description** |
| | | 7:3 | Reserved |
