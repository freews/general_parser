...
| | 03:02 | | | Reserved |
| | (NIDL + 3):04 | | | **Namespace Identifier (NID):** For an NIDT value of 1h, 2h, and 3h, this field contains a value that is globally unique. The type of the value is specified by the Namespace Identifier Type (NIDT) field, and the size is specified by the Namespace Identifier Length (NIDL) field. |
