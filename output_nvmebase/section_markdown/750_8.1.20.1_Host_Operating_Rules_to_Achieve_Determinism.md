...
#### Figure 1: Figure 687 is an example that shows the relationship between the typical and reliable estimate values for
DTWIN Reads. DTWIN Reads Reliable Estimate begins near the DTWIN Reads Typical value at the start
![Figure 687 is an example that shows the relationship between the typical and reliable estimate values for
DTWIN Reads. DTWIN Reads Reliable Estimate begins near the DTWIN Reads Typical value at the start](../section_images/Figure_8_1_20_1_Host_Operating_Rules_to_Achieve_Determinism_1.png)


#### Figure 2: Figure 687: Typical and Reliable Estimate Example
![Figure 687: Typical and Reliable Estimate Example](../section_images/Figure_8_1_20_1_Host_Operating_Rules_to_Achieve_Determinism_2.png)
