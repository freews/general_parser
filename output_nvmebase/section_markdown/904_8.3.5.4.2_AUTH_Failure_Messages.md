...
#### Table 1: Table_8_3_5_4_2_AUTH_Failure_Messages
![Table_8_3_5_4_2_AUTH_Failure_Messages](../section_images/Table_8_3_5_4_2_AUTH_Failure_Messages.png)

| Bytes | Description |
| :--- | :--- |
| 0 | **Authentication Type (AUTH_TYPE):** 00h (i.e., common messages) |
| 1 | **Authentication Identifier (AUTH_ID):** |
...
| 04h | Hash function not usable: The HashList proposed by the host does not satisfy the security requirements of the controller (refer to section 8.3.5.5.2). |
