...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| | | **0** | **1** | **2** | **3** | **4** | **5** |
| 0 | Admin Queue: Host initializes<br>Completion Queue and sets CC.EN to '1'<br><br>I/O Queue: Host initializes<br>Completion Queue and submits<br>Create I/O Completion Queue command | P(0) (E)<br>HEAD-><br>TAIL-> | P(0) (E) | P(0) (E) | P(0) (E) | P(0) (E) | P(0) (E) |
| 1 | Controller has completed 1 command and the host has consumed 0 completions | P(1) HEAD-> | P(0) (E)<br>TAIL-> | P(0) (E) | P(0) (E) | P(0) (E) | P(0) (E) |
| 2 | Controller has completed 6 commands and the host has consumed 2 completions | P(1) TAIL-> | P(1) (E) | P(1) HEAD-> | P(1) (E) | P(1) (E) | P(1) (E) |
