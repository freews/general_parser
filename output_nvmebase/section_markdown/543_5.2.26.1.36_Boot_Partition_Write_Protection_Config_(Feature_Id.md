...
| :--- | :--- |
| 31:06 | Reserved |
| 05:03 | **Boot Partition 1 Write Protection State (BP1WPS):** This field specifies the write protection state of Boot Partition 1.<br>The default value of this field is Write Locked.<br><br>![](https://i.imgur.com/1234567.png) |
| | |
| Bits | Description |
| 02:00 | **Boot Partition 0 Write Protection State (BP0WPS):** This field specifies the write protection state of Boot Partition 0.<br>The default value of this field is Write Locked.<br><br>![](https://i.imgur.com/1234567.png) |
| | |
| | Notes:<br>1. A value of 000b is not returned by a controller via a Get Features command. This value is only used in the Set Features command. |
