...
#### Table 1: Table_5_4_8_1_1_Associate_Namespace_Management_Operation_01h
![Table_5_4_8_1_1_Associate_Namespace_Management_Operation_01h](../section_images/Table_5_4_8_1_1_Associate_Namespace_Management_Operation_01h.png)

| Bytes | Description |
| :--- | :--- |
| 31:00 | **Exported Namespace ID (ENSID)**: A valid and unassociated Exported NSID to be associated to an Underlying Namespace and associated with the specified Exported NVM Subsystem. |
| 253:32 | **Exported NVM Subsystem NQN (ENSQN)**: Identifies an existing Exported NVM Subsystem to be associated with the Exported Namespace ID. |
| 285:254 | **Underlying Namespace ID (UNSID)**: An active Namespace ID to which Exported Namespace ID (ENSID) is to be associated. Refer to Figure 65 for the definition of NSID types and relationship to namespaces. |
