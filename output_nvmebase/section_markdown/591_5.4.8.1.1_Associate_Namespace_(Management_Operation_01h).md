...
| 285:254 | **Underlying Namespace ID (UNSID):** An active Namespace ID to which Exported Namespace ID is to be associated. Refer to Figure 65 for the definition of NSID types and relationship to namespaces. |
