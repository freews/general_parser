...
#### Table 1: Table_5_2_16_Migration_Receive_command
![Table_5_2_16_Migration_Receive_command](../section_images/Table_5_2_16_Migration_Receive_command.png)
...
| 15:08 | **Reserved** |
| 07:00 | **Select (SEL):** This field specifies the type of management operation to perform.<br><table><tr><th>Value</th><th>M/O<sup>1</sup></th><th>Management Operation</th><th>Reference Section</th></tr><tr><td>0h</td><td>M</td><td>Get Controller State</td><td>5.2.16.1.1</td></tr><tr><td>1h to FFh</td><td></td><td>Reserved</td><td></td></tr></table><br>Notes:<br>1. O/M definition: O = Optional, M = Mandatory |
| Bits | Description |
...
| Bits | Description |
| 31:00 | **Number of Dwords (NUMDL):** This field specifies the number of dwords to return. If the host specifies a value that is greater than the number of dwords returned by the specified management operation of the command, then the controller returns the number of dwords defined by the specified management operation of the command with undefined results for the remaining dwords. This is a 0-based value. |
