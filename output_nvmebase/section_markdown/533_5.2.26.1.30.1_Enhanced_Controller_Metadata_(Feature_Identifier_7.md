...
#### Table 1: Table_5_2_26_1_30_1_Enhanced_Controller_Metadata_Feature_Identifier_7Dh
![Table_5_2_26_1_30_1_Enhanced_Controller_Metadata_Feature_Identifier_7Dh](../section_images/Table_5_2_26_1_30_1_Enhanced_Controller_Metadata_Feature_Identifier_7Dh.png)
...
| 10h | **Host-Determined Failure Record:** A failure record (e.g., the reason the host has flagged a failure for an NVMe Storage Device (refer to the NVM Express Management Interface Specification) FRU which can be used for failure analysis) as a UTF-8 string. |
| 11h to 17h | Reserved |
