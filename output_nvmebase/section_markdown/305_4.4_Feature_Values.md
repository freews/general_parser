...
#### Table 1: Table_4_4_Feature_Values_1
![Table_4_4_Feature_Values_1](../section_images/Table_4_4_Feature_Values_1.png)
...
#### Table 2: Table_4_4_Feature_Values_2
![Table_4_4_Feature_Values_2](../section_images/Table_4_4_Feature_Values_2.png)

| Feature Capability | Controller scope or Namespace per controller scope | NVM subsystem scope | Endurance Group scope | NVM Set scope | Namespace scope |
| :--- | :--- | :--- | :--- | :--- | :--- |
| Saveable | Set to:<br>• the saved value if a saved value is set; or<br>• the default value if a saved value is not set, unless otherwise specified. | | | | Unchanged, unless otherwise specified. |
| Non-saveable and non-persistent | Set to the default value, unless otherwise specified. | | | | |
