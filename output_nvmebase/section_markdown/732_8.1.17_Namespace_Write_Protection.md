...
#### Figure 1: Figure 669 defines the write protection states that may be supported for a namespace. All states persist
across power cycles and Controller Level Resets (refer to section 3.7.2) except Write Protect Until Power
Cycle state, which transitions to the No Write Protect state on the occurrence of a power cycle.
![Figure 669 defines the write protection states that may be supported for a namespace. All states persist
across power cycles and Controller Level Resets (refer to section 3.7.2) except Write Protect Until Power
Cycle state, which transitions to the No Write Protect state on the occurrence of a power cycle.](../section_images/Figure_8_1_17_Namespace_Write_Protection_1.png)


#### Figure 2: Figure 670: Namespace Write Protection State Machine Model
![Figure 670: Namespace Write Protection State Machine Model](../section_images/Figure_8_1_17_Namespace_Write_Protection_2.png)
