...
| 01 | Data Frame Header Length (DFHL): This field shall specify the length in bytes of this header. This field shall be set to 4h. | |
...
| 01 | Data Frame Header Length (DFHL): This field indicates the length in bytes of the header. This field shall be set to 4h. | |
...
| Bits | Description | |
| 7:0 | Result Code: This field indicates the operation status. Valid operation status values are listed below. | |
| | Value | Definition |
