...
#### Table 1: Table_5_2_28_1_2_Track_Memory_Changes_Management_Operation_1h_1
![Table_5_2_28_1_2_Track_Memory_Changes_Management_Operation_1h_1](../section_images/Table_5_2_28_1_2_Track_Memory_Changes_Management_Operation_1h_1.png)
...
#### Table 2: Table_5_2_28_1_2_Track_Memory_Changes_Management_Operation_1h_2
![Table_5_2_28_1_2_Track_Memory_Changes_Management_Operation_1h_2](../section_images/Table_5_2_28_1_2_Track_Memory_Changes_Management_Operation_1h_2.png)
...
| | |
| Bytes | Description |
| 07:00 | **Address (SADDR):** This field specifies the starting 64-bit address of the memory range where the address is host memory (refer to section 1.5.47) associated with the controller specified by the CNTLID field (refer to Figure 496). The address is aligned to the granularity specified by the RMR TG field. For example, if the value in the RMR TG field is 8h, then the value in this field is required to be aligned to 1 MiB (i.e., bits 19:0 are cleared to 0h). |
| 11:08 | **Length (LEN):** This field specifies the length of this host memory range in units of the tracking granularity as defined by RMR TG. For example, if the value n in the RMR TG field is 8h, and the value of this field is 4h, then the length of this memory range is 1 MiB * 4h which is 4 MiB. |


#### Table 3: Table_5_2_28_1_2_Track_Memory_Changes_Management_Operation_1h_3
![Table_5_2_28_1_2_Track_Memory_Changes_Management_Operation_1h_3](../section_images/Table_5_2_28_1_2_Track_Memory_Changes_Management_Operation_1h_3.png)

| Bits | Description |
| :--- | :--- |
| 31:16 | Reserved |
| 15:00 | Memory Range Tracking Granularity (MRTG): This field indicates the lowest granularity that the controller is able to track the memory changes with the specified Memory Range Tracking Descriptor list (refer to Figure 497).<br>This units for this field is defined by the RMRTG field. |
| | |
| Bits | Description |
