...
#### Table 1: Table_4_3_1_Physical_Region_Page_Entry_and_List_1
![Table_4_3_1_Physical_Region_Page_Entry_and_List_1](../section_images/Table_4_3_1_Physical_Region_Page_Entry_and_List_1.png)
...
#### Table 2: Table_4_3_1_Physical_Region_Page_Entry_and_List_2
![Table_4_3_1_Physical_Region_Page_Entry_and_List_2](../section_images/Table_4_3_1_Physical_Region_Page_Entry_and_List_2.png)

| Bits | Description |
| :--- | :--- |
| 63:00 | **Page Base Address and Offset (PBAO):** This field indicates the 64-bit physical memory page address. The least significant bits (n:0) of this field indicate the offset within the memory page (e.g., if the memory page size is 4 KiB, then bits 11:0 form the Offset; if the memory page size is 8 KiB, then bits 12:0 form the Offset). If the entry is not the first PRP entry in the command or a PRP List pointer in a command, then the Offset portion of this field shall be cleared to 0h. The Offset shall be dword aligned, indicated by bits 1:0 being cleared to 00b.<br>**Note:** The controller is not required to check bits 1:0 are cleared to 00b. The controller may report an error of PRP Offset Invalid if bits 1:0 are not cleared to 00b. If the controller does not report an error of PRP Offset Invalid, then the controller shall operate as if bits 1:0 are cleared to 00b. |


#### Table 3: Table_4_3_1_Physical_Region_Page_Entry_and_List_3
![Table_4_3_1_Physical_Region_Page_Entry_and_List_3](../section_images/Table_4_3_1_Physical_Region_Page_Entry_and_List_3.png)

| 63 | Page Base Address p | n+1 | n | 0 |
| :--- | :--- | :--- | :--- | :--- |
