...
| Asynchronous Event Configuration | 0Bh | M | O⁸ | M¹⁰ | | 5.2.26.1.5 |
...
| Power Loss Signaling Config | 1Bh | O | P | P | | 5.2.26.1.19 |
...
| Flexible Data Placement Events | 1Eh | O⁶ | P | P | | 5.2.26.1.21 |
| Namespace Admin Label | 1Fh | O | O | | | 5.2.26.1.22 |
...
| 6. Mandatory for controllers that support the Flexible Data Placement capability (refer to section 8.1.11). Refer to the FDPB bit in Figure 328. | | | | | | |
