...
#### Figure 1: Figure 624: Set Features Boot Partition Write Protection State Machine Model
![Figure 624: Set Features Boot Partition Write Protection State Machine Model](../section_images/Figure_8_1_3_3_1_Set_Features_Boot_Partition_Write_Protection_1.png)


#### Figure 2: Figure 625 defines the write protection states per Boot Partition if Set Features Boot Partition Write
Protection is supported.
![Figure 625 defines the write protection states per Boot Partition if Set Features Boot Partition Write
Protection is supported.](../section_images/Figure_8_1_3_3_1_Set_Features_Boot_Partition_Write_Protection_2.png)
