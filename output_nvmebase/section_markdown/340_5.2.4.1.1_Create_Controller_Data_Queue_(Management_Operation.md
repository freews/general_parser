...
| 15:08 | Reserved |
| Bits | Description |
| 07:00 | Queue Type (QT): This field specifies the type of queue to be created which defines the information that the controller posts into the entries of the queue. <br> | Value | Definition | Reference Section |
