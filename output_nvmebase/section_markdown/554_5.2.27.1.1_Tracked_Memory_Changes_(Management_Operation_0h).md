...
| 01 | |
| 03:02 | **Controller identifier (CNTLID):** This field indicates the identifier for the controller whose memory modifications are being tracked and reported in the Tracked Memory Changed Descriptor list (i.e., the same controller identifier as specified by the host in the Management Operation Specific field (refer to Figure 498)). |
