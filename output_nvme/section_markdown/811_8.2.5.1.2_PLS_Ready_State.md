...
![Untitled Table](../section_images/table_690_128.png)
...
| | EPF Processing <br> Port Disabled | • The controller is configured for EPF processing; <br> • the controller implements the EPF Processing Port Disabled state; <br> and <br> • the PLN variable transitions from Deasserted to Asserted. |
| | EPF Processing <br> Port Enabled | • The controller is configured for EPF processing; <br> • the controller implements the EPF Processing Port Enabled state; <br> and <br> • the PLN variable transitions from Deasserted to Asserted. |
