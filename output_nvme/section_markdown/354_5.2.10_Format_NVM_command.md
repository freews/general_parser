...
![Untitled Table](../section_images/table_225_186.png)

| | | | |
| :--- | :--- | :--- | :--- |
| 0 | N/A | FFFFFFFFh¹ | All namespaces attached to the controller. Other namespaces are not affected. |
| 0 | N/A | Any allocated value (refer to section 3.2.1.3) | The specified namespace. Other namespaces are not affected. |
| 1 | N/A | Any allocated value (refer to section 3.2.1.3) or FFFFFFFFh | All namespaces that exist in the NVM subsystem. |
| | | | |
...
![Untitled Table](../section_images/table_226_424.png)

(Continuation of Untitled Table - see first part)


#### Table 3: Untitled Table
![Untitled Table](../section_images/table_227_128.png)
