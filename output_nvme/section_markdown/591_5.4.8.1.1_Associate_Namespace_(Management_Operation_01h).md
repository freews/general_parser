...
![Untitled Table](../section_images/table_503_400.png)

| | |
| :--- | :--- |
| | Underlying Controller ID (UCTRLID): Identifies the Underlying Controller used to access the specified Underlying Namespace. |
| | Underlying NVM Subsystem NQN (UNSNQN): Identifies the Underlying NVM Subsystem which provides the Underlying Namespace to be associated with the Exported Namespace ID. |
| | Reserved |
