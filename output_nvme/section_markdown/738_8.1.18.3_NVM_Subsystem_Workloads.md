...
![Untitled Table](../section_images/table_614_128.png)

| | |
| :--- | :--- |
| 01b | **Workload 1: Extended Idle Period with a Burst of Random Writes.** Workload #1 consists of five (5) minutes of idle followed by thirty-two (32) random write commands of size 1 MiB submitted to a single controller while all other controllers in the NVM subsystem are idle, and then thirty (30) seconds of idle. |
