...
![Untitled Table](../section_images/table_751_722.png)
...
| +2*HL:16+HL | **Challenge Value (CVAL)**: Challenge C₂, if valid (i.e., if the CVALID field is set to 01h), cleared to 0h otherwise. |
| +DHVLEN:6+2*HL | **DH Value (DHV)**: DH exponential gʸ mod p. This field is not present (i.e., the CVAL field is the last field in the message) if DHVLEN is cleared to 0h. |


#### Table 2: Untitled Table
![Untitled Table](../section_images/table_752_128.png)
