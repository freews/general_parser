...
![Untitled Table](../section_images/table_329_253.png)

| | Description |
|---|---|
| Controller ID (CNTLID): | This field indicates the controller ID of the LHC Controller. |
| Loss Count (LC): | This field contains a count of the number of lost host communication events that are reported by this entry (i.e., the number of lost host communication events since the last time that this |


#### Table 2: Untitled Table
![Untitled Table](../section_images/table_329_513.png)
