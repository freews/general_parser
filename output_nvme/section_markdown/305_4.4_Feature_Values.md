...
![Untitled Table](../section_images/table_186_620.png)

| Capability | per controller scope | scope | Group scope | scope | scope |
| :--- | :--- | :--- | :--- | :--- | :--- |
| Saveable | Set to:<br>• the saved value if a saved value is set; or<br>• the default value if a saved value is not set, unless otherwise specified. | | | | |
| Saveable<br>non-consistent | Set to the default value, unless otherwise specified. | | | | |
| | | Unchanged, unless otherwise specified. | | | |


#### Table 2: Untitled Table
![Untitled Table](../section_images/table_187_128.png)
