...
| | | | | | | |
| **ACE** | | | | | | |
| | | 00 00 00 08 00 03 90 00 | "ACE_ACE_Get_All" | | Admins | All |
...
| | | 00 00 00 08 00 A8 A0 00 (+MMMM) | "ACE_C_PIN_UserMMMM_Set_PIN" | | Admins OR UserMMMM *ACE1 | PIN |
| | | | | | | |
| **K_AES** | | | | | | |
...
| | | | | | | |
| **(O)** | | | | | | |
| | | 00 00 00 08 00 03 B0 00 (+NNNN) | "ACE_K_AES_128_RangeNNNN_GenKey" | | Admins | All |
| | | | | | | |
| **K_AES_256** | | | | | | |
...
| | | | | | | |
| **MBRControl** | | | | | | |
| | | 00 00 00 08 00 03 FC 00 | "ACE_Locking_GlblRng_Admins_Set" | | Admins | ReadLockEnabled, WriteLockEnabled, ReadLocked, WriteLocked, LockOnReset |
| | | 00 00 00 08 00 03 FC 01 | "ACE_Locking_Admins_RangeStartToLOR" | | Admins | RangeStart, RangeLength, ReadLockEnabled, WriteLockEnabled, ReadLocked, WriteLocked, LockOnReset |
| | | | | | | |
| **DataStore** | | | | | | |
| | | 00 00 00 08 00 03 FC 00 | "ACE_MBRControl_Admins_Set" | | Admins | Enable, Done, DoneOnReset |
| | | 00 00 00 08 00 03 FB 01 | "ACE_MBRControl_Set_DoneToDOR" | | Admins | Done, DoneOnReset |
| | | | | | | |
| **(O)** | | | | | | |
