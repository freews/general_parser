...
> **Section ID**: 4.3.7 | **Page**: 90-90

4.3.7 Storage Device Read/Write Data Command Locking Behavior Interactions with Range 
Crossing 
If a Storage Device receives a read or write command that spans multiple Locking ranges and the Locking ranges 
are not locked, the Storage Device SHALL either: 
• 
