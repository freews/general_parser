...
#### Table 1: At least one of the objects shown in Table 42 SHALL be supported
![At least one of the objects shown in Table 42 SHALL be supported](../section_images/table_084_655.png)
