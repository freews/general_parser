...
#### Table 1: Activate is an Opal SSC-specific method for managing the life cycle of SPs created in manufacturing (Manufactured  SP), whose initial life cycle state is “Manufactured-Inactive”. The following pseudo-code is the signature of the  Activate method (see [2] for more information).
![Activate is an Opal SSC-specific method for managing the life cycle of SPs created in manufacturing (Manufactured  SP), whose initial life cycle state is “Manufactured-Inactive”. The following pseudo-code is the signature of the  Activate method (see [2] for more information).](../section_images/table_091_272.png)
