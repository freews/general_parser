...
#### Table 1: ** means the present current state of the respective feature
![** means the present current state of the respective feature](../section_images/table_020_673.png)
