...
| | 153 | PEC: An 8-bit CRC calculated over the SMBus address, command code, second SMBus address and returned data. The algorithm is defined in the SMBus Specification. |
...
| | 199:168 | Panic Context Buffer: Vendor may record additional bytes about the Panic ID reported in Command 154. Any unused bytes shall be cleared to zero. |
