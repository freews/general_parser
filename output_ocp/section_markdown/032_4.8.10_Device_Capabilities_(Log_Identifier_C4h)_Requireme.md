...
| | | | | <table><tbody><tr><th>Bit</th><th>Description</th></tr><tr><td>15</td><td>Shall be set to 1b if the device has been tested and found to comply with the OOB Management requirements of this specification.</td></tr><tr><td>14:3</td><td>Reserved. Shall be cleared to zero.</td></tr><tr><td>2</td><td>Shall be set to 1b if NVMe Basic Management Command is supported.</td></tr><tr><td>1</td><td>Shall be set to 1b if MCTP over PCIe VDM is supported.</td></tr><tr><td>0</td><td>Shall be set to 1b if MCTP over SMBus is supported.</td></tr></tbody></table> |
...
| DCLP-12 | 4095:408 | Log Page GUID | 16 | Shall be set to B7053C914B58495D98C9E1D1D0D54297h. |
