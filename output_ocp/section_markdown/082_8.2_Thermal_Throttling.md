...
| TTHROTTLE-3 | Thermal throttling shall only engage under certain failure conditions such as excessive server ambient temperature or beyond the server's fan failure redundancy limit. The required behavior is illustrated below:<br><img src="image_url" alt="Thermal Throttling Diagram"> |
