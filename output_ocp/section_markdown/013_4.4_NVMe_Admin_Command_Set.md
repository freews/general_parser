...
| NVMe-AD-2 | Identify – In addition to supporting all the mandatory CNS values and the associated mandatory fields within the CNS, the following optional fields in the CNS shall be supported:<br>• Format progress indicator (FPI).<br>• I/O Performance and Endurance Hints:<br>  o NSFEAT bit 4 = 1b. |
