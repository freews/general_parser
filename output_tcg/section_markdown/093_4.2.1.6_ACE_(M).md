...
#### Table 1: Table 23 contains Optional rows designated with (O).
![Table 23 contains Optional rows designated with (O).](../section_images/Table_4_2_1_6_ACE_M_1.png)
...
#### Table 2: Table 23 - Admin SP - ACE Table Preconfiguration
![Table 23 - Admin SP - ACE Table Preconfiguration](../section_images/Table_4_2_1_6_ACE_M_2.png)
