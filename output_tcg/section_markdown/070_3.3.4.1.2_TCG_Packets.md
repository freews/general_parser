...
> **Section ID**: 3.3.4.1.2 | **Page**: 31-31
...
The TPer MAY ignore Credit Control Subpackets sent by the host. The host may discover TPer support of Cred
...
(M)
The TPer MAY ignore packet sequence numbering and not enforce any sequencing behavior. Refer to [2] for detail
