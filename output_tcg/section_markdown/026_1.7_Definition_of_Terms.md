...
#### Table 1: Table_1_7_Definition_of_Terms
![Table_1_7_Definition_of_Terms](../section_images/Table_1_7_Definition_of_Terms.png)

| Term | Definition |
| :--- | :--- |
| data removal operation | User Data Removal Method (see [4]) |
| Eradicate | irreversibly erase (e.g., cryptographically erase) |
