...
#### Table 1: Table 39 contains Optional rows designated with (O).
![Table 39 contains Optional rows designated with (O).](../section_images/Table_4_3_1_7_ACE_M_1.png)
...
#### Table 2: Table 39 - Locking SP - ACE Table Preconfiguration
![Table 39 - Locking SP - ACE Table Preconfiguration](../section_images/Table_4_3_1_7_ACE_M_2.png)
