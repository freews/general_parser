...
#### Table 1: Table 36 contains Optional rows designated with (O).
![Table 36 contains Optional rows designated with (O).](../section_images/Table_4_3_1_3_Table_M_1.png)
...
#### Table 2: Table 36 - Locking SP - Table Table Preconfiguration
![Table 36 - Locking SP - Table Table Preconfiguration](../section_images/Table_4_3_1_3_Table_M_2.png)
