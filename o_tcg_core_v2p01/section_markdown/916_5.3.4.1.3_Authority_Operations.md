...
> **Section ID**: 5.3.4.1.3 | **Page**: 213-214
...
a. None – This describes an authority that MAY be used to reference a response signing or
...
b. Password – This describes an authority that MAY be used and authenticated with its
...
c. Sign – This describes an authority that MAY be used and authenticated using a challenge
...
Sign operation encompasses both Signing and Verification activities – the TPer SHALL
...
d. Exchange – This describes an authority that MAY be used during session startup, and
...
e. SymK – This describes an authority that MAY be used and authenticated using a challenge
...
f.
HMAC – This describes an authority that MAY be used and authenticated using a
...
SPSigningAuthority. Referencing an authority with this Operation column value in another
authority parameter of the session startup methods SHALL result in an error.
g. TPerSign – This describes the signing authority that represents the TPer, which enables
...
h. TPerExchange – This describes the exchange authority that represents the TPer.  This
authority enables the host to establish a secure session with an SP using the TPer’s
