...
> **Section ID**: 5.1.4.2.5 | **Page**: 130-131
...
a. Year – this Named value has the Name "0x00" and a value that is implicitly defined as
...
b. Month – this Named value has the Name "0x01" and a value that is implicitly defined as
...
l.
December = 12 (0x0C)
c. Day – this Named value has the Name "0x02" and a value that is implicitly defined as being
...
d. Hour – this Named value has the Name "0x03" and a value that is implicitly defined as
...
e. Minute – this Named value has the Name "0x04" and a value that is implicitly defined as
...
f.
Seconds – this Named value has the Name "0x05" and a value that is implicitly defined as
...
g. Fraction – this Named value has the Name "0x06" and a value that is implicitly defined as
