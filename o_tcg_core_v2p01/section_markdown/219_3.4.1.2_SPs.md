...
b. A set of tables – Tables SHOULD be stored in a non-user addressable storage area on the
TPer.
c. A set of methods – The supported methods define the operations that MAY be performed
