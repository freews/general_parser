...
> **Section ID**: 5.1.5.11 | **Page**: 139-139
...
b. If an attempt is made to set a cell to a value larger (or smaller) than that cell’s type allows,
...
f.
A parameterized value is larger or smaller than the value required by that method
invocation
...
StartSession method’s HostSigningAuthority parameter is a class authority.
