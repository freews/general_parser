...
> **Section ID**: 5.3.4.2.1 | **Page**: 221-223
...
prevent the value from being changed – in such a case the TPer SHALL return an
...
the Column table row of the table’s first column.  Tables and their Table table entries are
...
including the column’s name and data type, whether the column value is part of the unique
...
f.
ACEObjectUID.Get/Set (if a new ACE is created)
