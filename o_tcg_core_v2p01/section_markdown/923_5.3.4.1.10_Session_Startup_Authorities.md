...
> **Section ID**: 5.3.4.1.10 | **Page**: 217-217
...
HostSigningAuthority’s credential as appropriate, and then submit the signed challenge back to the SP
...
using the SPSigningAuthority’s credential as appropriate, and submit the signed challenge back to the
