...
> **Section ID**: 5.4.4.2 | **Page**: 235-235

The TPer owner, or a host with equivalent permissions, is able to delete an SP by opening a session to
the Admin SP and invoking the Delete method on the SP object in the Admin SP’s SP table.
...
2. The value of the Instances column of the Admin SP’s Template table is reduced by 1 for each
