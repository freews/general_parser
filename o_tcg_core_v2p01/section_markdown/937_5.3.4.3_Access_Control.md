...
> **Section ID**: 5.3.4.3 | **Page**: 226-226

Access control describes the system used to prevent modification of an SP’s contents by a host that
...
InvokingID/MethodID combination SHALL fail and result in status code NOT AUTHORIZED.
