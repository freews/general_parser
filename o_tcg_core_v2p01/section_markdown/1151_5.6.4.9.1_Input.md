...
> **Section ID**: 5.6.4.9.1 | **Page**: 257-257
...
For the Sign method invoked on a hash object, the data in the hash object’s Accumulator column is
signed using the private part of the key pair of the public key credential referenced in the hash object’s
