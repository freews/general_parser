...
> **Section ID**: 5.3.2.3 | **Page**: 156-157
...
CommonName column value that is the name of the template from which that table was issued – the
template name is the name from the associated row in the Admin SP’s Template table.
...
#### Table 1: Table 171 Table Table Description
![Table 171 Table Table Description](../section_images/Table_5_3_2_3_Table_and_Method_Metadata_Group_Table_Object_Table.png)
