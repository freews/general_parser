...
b. Enumeration types – values of this type require no special handling in the messaging
stream.
...
e. Restricted Reference types – values of this type require no special handling in the
messaging stream.
f.
General Reference types – values of this type require no special handling in the messaging
stream.
...
Example: F2 tokenized name tokenized value F3
h. Struct value types – Structs allow the creation of composite types by combining Named
...
F3 F1
i.
Set value types – values of this type are encoded as follows:
...
Example: F0 tokenized value tokenized value F1
