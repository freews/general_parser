...
> **Section ID**: 5.6.5.4 | **Page**: 266-266

Invocation of the XOR method causes the XOR method’s input data to be XORed with the pattern
...
of the byte table referenced as the PatternInput SHALL be set to all 00’s.  If the DeletePattern
...
If the host’s intention is to use the XOR method as a one-time pad, the host SHOULD invoke the XOR
