...
f.
Default ACL values for access control associations when a new table or object is
...
i.
Certificate related components, including the
Certificates table and the
PresentCertificate column of the Authority table.
j.
Issuance related components, including the IssueSP method.
