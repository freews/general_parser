...
> **Section ID**: 5.5.5.3 | **Page**: 245-246
...
To support Host interaction with the Clock Template-enabled SP, two virtual variables – HighTime and
LowTime – are used.  HighTime and LowTime internally represent actual current time values.
