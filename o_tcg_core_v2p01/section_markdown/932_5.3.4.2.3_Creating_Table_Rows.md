...
> **Section ID**: 5.3.4.2.3 | **Page**: 223-224
...
a. Table – the TPer automatically creates rows in the Table table upon successful invocation
of the CreateTable method.
b. Column – the TPer automatically creates rows in the Column table upon successful
invocation of the CreateTable method.
c.
MethodID – the TPer SHALL NOT permit rows to be created in the MethodID table via the
CreateRow method.
...
AccessControl table.
e. Log – the TPer SHALL NOT permit rows to be created in the Log table via the CreateRow
method.
f.
LogList – the TPer automatically creates rows in the LogList table upon successful
