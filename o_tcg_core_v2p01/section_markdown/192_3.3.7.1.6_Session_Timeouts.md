...
> **Section ID**: 3.3.7.1.6 | **Page**: 76-76
...
TPer’s property response for MaxSessionTimeout is zero and the SP’s SPSessionTimeout value is
zero.  Otherwise, the method SHALL fail with a SyncSession status of INVALID PARAMETER.
