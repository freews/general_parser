...
> **Section ID**: 5.7.2.2 | **Page**: 273-273

Locking table rows define encryption, re-encryption, read locking, and write locking configuratoin for
the Storage Device’s LBA ranges. An LBA range is defined as an ordered sequence of RangeLength
...
#### Table 1: Table 226 Locking Table Description
![Table 226 Locking Table Description](../section_images/Table_5_7_2_2_Locking_Object_Table.png)
