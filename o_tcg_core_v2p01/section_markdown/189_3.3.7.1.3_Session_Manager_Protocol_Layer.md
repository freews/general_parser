...
> **Section ID**: 3.3.7.1.3 | **Page**: 73-74
...
characteristics. The Session Manager protocol layer does not provide a session “to” any SP – it
...
invocation process, such as logging or PIN retry counts. In cases where these changes occur – for
example, logging a StartSession method call success or failure – the change SHALL occur on the SP
...
layer methods’ responses are formatted as method calls, so that the host is able to identify responses
