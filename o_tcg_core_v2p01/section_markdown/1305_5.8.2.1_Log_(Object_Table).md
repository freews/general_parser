...
> **Section ID**: 5.8.2.1 | **Page**: 291-292
...
name.  Only the default Log table, which has the name “Log”, stores System log entries.  The Log table
...
#### Table 1: Table 233 Log Table Description
![Table 233 Log Table Description](../section_images/Table_5_8_2_1_Log_Object_Table.png)
