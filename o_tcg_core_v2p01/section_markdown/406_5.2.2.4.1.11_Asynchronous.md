...
> **Section ID**: 5.2.2.4.1.11 | **Page**: 147-148
...
f.
The host SHOULD accept Credit Control Subpackets from the TPer, and SHOULD only
...
f.
The host SHOULD ignore Credit Control Subpackets from the TPer.
