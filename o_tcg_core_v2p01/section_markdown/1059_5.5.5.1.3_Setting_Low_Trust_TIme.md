...
> **Section ID**: 5.5.5.1.3 | **Page**: 244-245
...
2. The SP returns a Result of “True”, indicating that the ExactTime value was received and
processed.
...
not, the SetClockLow method’s ExactTime values to be stored in the ClockTime table SHALL
