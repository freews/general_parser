...
capabilities.
This TCG Storage Architecture’s access control system scales with the available Storage Device
...
application-definable up to the limit of the Storage Device’s available resources.
