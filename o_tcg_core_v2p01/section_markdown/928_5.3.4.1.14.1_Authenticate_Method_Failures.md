...
> **Section ID**: 5.3.4.1.14.1 | **Page**: 219-221
...
Authority table.
b. All of the authority’s attributes are appropriate for the existing session and
authentication attempt – the secure messaging properties are appropriate, the authority
...
valid – the secure messaging requirements have not been met, the authority is
...
c. All of the authority’s attributes are appropriate for the existing session and
authentication attempt – the secure messaging properties are appropriate, the authority
is enabled, references a valid credential, etc.
