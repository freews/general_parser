...
> **Section ID**: 5.3.2.7 | **Page**: 161-162

Begin Informative Content
The AccessControl table contains SP/method, table/method, and object/method access control
associations and logging settings, and each access control association’s related meta-ACL access
...
#### Table 1: Table 175 AccessControl Table Description
![Table 175 AccessControl Table Description](../section_images/Table_5_3_2_7_Table_and_Method_Metadata_Group_AccessControl_Object_Table.png)
