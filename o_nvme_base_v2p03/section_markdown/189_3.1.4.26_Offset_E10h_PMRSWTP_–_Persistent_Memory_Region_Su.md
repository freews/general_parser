...
| 7:4 | RO | 0h | Reserved |
| 3:0 | RO | Impl Spec | PMR Sustained Write Throughput Units (PMRSWTU): Indicates the granularity of the PMR Sustained Write Throughput field.<br>![](https://i.imgur.com/1d1d1d1.png) |
| | | | |
