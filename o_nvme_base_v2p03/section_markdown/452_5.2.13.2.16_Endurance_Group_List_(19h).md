...
| Bits | Description |
| :--- | :--- |
| 15:0 | **Endurance Group Identifier (ENGID):** This field specifies the Endurance Group Identifier (refer to section 3.2.3) of the first Endurance Group of the ordered list of Endurance Group Identifiers to be returned. |
| Bytes | Description |
| | **Header** |
