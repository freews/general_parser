...
#### Table 1: Table_5_2_27_1_1_Tracked_Memory_Changes_Management_Operation_0h_1
![Table_5_2_27_1_1_Tracked_Memory_Changes_Management_Operation_0h_1](../section_images/Table_5_2_27_1_1_Tracked_Memory_Changes_Management_Operation_0h_1.png)
...
#### Table 2: Table_5_2_27_1_1_Tracked_Memory_Changes_Management_Operation_0h_2
![Table_5_2_27_1_1_Tracked_Memory_Changes_Management_Operation_0h_2](../section_images/Table_5_2_27_1_1_Tracked_Memory_Changes_Management_Operation_0h_2.png)
...
| | |
| | **Controller identifier (CNTLID):** This field indicates the identifier for the controller whose memory modifications are being tracked and reported in the Tracked Memory Changed Descriptor list (i.e., the same controller identifier as specified by the host in the Management Operation Specific field (refer to Figure 498)). |
| 03:02 | |
...
| 11:08 | **Length (LEN):** This field specifies the length of this memory range in units of the tracking granularity as indicated in the RPMPG field. For example, if the value in the RPMPG field is 8h and the value of this field is 4h then the length of this memory range is 1 MiB * 4h which is 4 MiB. |
| 15:12 | Reserved |
