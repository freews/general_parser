...
| 0Ah to EEh | Reserved |
| EFh to FFh | Reserved for future NVMe over Fabrics Asynchronous Event Notifications <br> Notes: <br> 1. Refer to the NVM Express NVM Command Set Specification. <br> 2. Refer to the NVM Express Zoned Namespace Command Set Specification. |
| Value | Definition |
| :--- | :--- |
