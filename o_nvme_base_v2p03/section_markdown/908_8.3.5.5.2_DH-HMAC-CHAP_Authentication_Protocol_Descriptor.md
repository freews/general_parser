...
| 3 | DHgIDList Length (DHELEN): Number of Diffie-Hellman group identifiers (1 to 30) |
...
| 33+DHELEN:34 | Diffie-Hellman Group Identifier List (DHgIDList): Array of Diffie-Hellman Group identifiers (one byte per identifier) |
| 63:34+DHELEN | Pad1 (PAD1): Padding bytes cleared to 0h, if present |
