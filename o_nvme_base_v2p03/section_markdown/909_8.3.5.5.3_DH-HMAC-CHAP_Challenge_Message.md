...
| 1 | Authentication Identifier (AUTH_ID): 01h (i.e., DH-HMAC-CHAP Challenge) |
| 3:2 | Reserved |
| 4 | Transaction Identifier (T_ID): 16-bit transaction identifier |
...
| 15:12 | Sequence Number (SEQUENUM): Sequence number S₁ |
