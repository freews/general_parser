...
| 02:00 | **Reservation Acquire Action (RACQA):** This field specifies the action that is performed by the command. <br> | Value | Definition | Reference |
