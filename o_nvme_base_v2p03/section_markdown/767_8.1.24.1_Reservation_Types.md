...
| Exclusive Access | Y | Y | N | N | Y | N | One Reservation Holder |
| Write Exclusive - Registants Only | Y | Y | Y | Y | Y | N | One Reservation Holder |
| Exclusive Access - Registants Only | Y | Y | Y | Y | N | N | One Reservation Holder |
| Write Exclusive - All Registants | Y | Y | Y | Y | Y | N | All Registants are Reservation Holders |
...
| | | | | | | |
| **NVMe Command** | Write Exclusive Reservation | Exclusive Access Reservation | Write Exclusive Registrants Only or Write Exclusive All Registrants Reservation | Write Exclusive Registrants Only or Write Exclusive All Registrants Reservation | Exclusive Access Registrants Only or Exclusive Access All Registrants Reservation | Exclusive Access Registrants Only or Exclusive Access All Registrants Reservation |
| | Non-Registrant | Non-Registrant | Non-Registrant | Registrant | Non-Registrant | Registrant |
| | | | | | | |
| **Write Command Group** | | | | | | |
...
| Sanitize (Admin) | | | | | | |
| Security Send (Admin)<sup>4</sup> | C | C | C | C | A | A |
