...
#### Table 1: Table_8_1_8_Device_Self_test_Operations
![Table_8_1_8_Device_Self_test_Operations](../section_images/Table_8_1_8_Device_Self_test_Operations.png)
...
| 6 – Data Integrity | Perform background housekeeping tasks, prioritizing actions that enhance the integrity of stored data.<br>Exit this segment in time to complete the remaining segments and meet the timing requirements for extended device self-test operation indicated in the Identify Controller data structure. | Metadata is corrupt and is not recoverable |
