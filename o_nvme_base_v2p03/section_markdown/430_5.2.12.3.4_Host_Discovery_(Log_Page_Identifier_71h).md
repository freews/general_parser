...
| Bytes | Description | |
|:---|:---|:---|
| | **Record Format (RECFMT):** This field indicates the format of the Host Discovery log page. If a new format is defined, this value is incremented by one. The format of the record specified in this definition shall be 0h. | |
| 17:16 | | |
