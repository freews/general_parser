...
| Bits | Type | Reset | Description |
| :--- | :--- | :--- | :--- |
| 06:04 | RW | 000b | **I/O Command Set Selected (CSS):** This field specifies the I/O Command Set or Sets that are selected. This field shall only be changed when the controller is disabled (i.e., CC.EN is cleared to '0'). The I/O Command Set or Sets that are selected shall be used for all I/O Submission Queues.<br>**Value** | **Definition** |
| | | | **CAP.CSS.NCCSS Bit** | **Definition** |
| | | | 000b | |
| | | | 1b | NVM Command Set |
| | | | 0b | Reserved |
| | | | 001b to 101b | Reserved |
| | | | **CAP.CSS.IOCCSS Bit** | **Definition** |
