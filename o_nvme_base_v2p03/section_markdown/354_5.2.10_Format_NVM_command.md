...
| Notes: | | | | |
| | | | | 1. If the Format NVM Broadcast Support (FNVMSB) bit in the FNA field is set to '1', then this value is not supported, and the command is aborted as described in this section. |
