...
| ... | ... |
| 255+LenZ1+...+LenZn-1:256+LenZ1+...+LenZn-1 | **Zone N (ZN):** This field contains the Nth Zone contained in this ZoneGroup as defined in Figure 741 (if present). The length of this field is represented as LenZn. |
