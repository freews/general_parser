...
| Bits | Description |
| :--- | :--- |
| 31:20 | **Command Scope (CSP):** This field defines the scope for the associated command. If the value of this field is 0h then no scope is reported. A command may have multiple scopes depending on the effects of the command based on the parameters passed to that command. For a command that supports multiple scopes, multiple bits may set to '1'. |
| | | **Bits** | **Description** |
| | | 11:6 | Reserved |
