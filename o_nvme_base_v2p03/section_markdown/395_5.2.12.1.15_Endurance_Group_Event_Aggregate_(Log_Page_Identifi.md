...
| ... | ... | |
| 2*NUMENT+7: | Entry NUMENT: Indicates the Endurance Group that has an Endurance Group Event pending that has the numerically largest Endurance Group Identifier, if any. | |
| 2*NUMENT+6 | | |
