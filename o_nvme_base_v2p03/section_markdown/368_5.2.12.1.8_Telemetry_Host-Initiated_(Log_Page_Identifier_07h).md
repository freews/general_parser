...
| 379:20 | Reserved |
| 380 | Telemetry Host-Initiated Scope (THS): This field indicates the scope of the Telemetry Host-Initiated log page. Implementations compliant with versions of this specification later than 2.0 shall not set this field to a value of 0h. |
