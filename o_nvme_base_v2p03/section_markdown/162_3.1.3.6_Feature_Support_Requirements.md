...
| Asynchronous Event Configuration | 0Bh | | | M⁸ | | 5.2.26.1.5 |
...
| Host Controlled Thermal Management | 10h | O | O | | | 5.2.26.1.9 |
...
| Host Behavior Support | 16h | | | O | | 5.2.26.1.14 |
...
| Reservation Persistence | 83h | O⁴ | | P | | 5.2.26.1.34 |
| Feature Name | Feature Identifier | Controller Support Requirements¹ | | | | Reference |
| | | I/O | Administrative | Discovery | | |
...
| 4. Mandatory if reservations are supported as indicated by a non-zero value in the Reservation Capabilities (RESCAP) field in the Identify Namespace data structure. | | | | | | |
